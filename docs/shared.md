...
| `ServerMessage` | Union: streaming chunks, tool calls, artifacts, context usage, errors, ready signal, chat history, push notifications (`board_changed`, `agents_changed`, `artifacts_changed`, `job_executions_changed`, `agent_busy_state`) |
