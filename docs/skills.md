...
| `live-dashboard` | conductor, reviewer, worker | Interactive HTML dashboard artifacts with live database queries via the postMessage bridge. Includes a copy-paste `queryDatabase` helper, workflow steps, Chart.js patterns, and a pre-flight checklist. |
