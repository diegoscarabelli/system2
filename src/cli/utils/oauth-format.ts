 ...
 * Returning a single formatted string lets every CLI surface (login, init,
 * config) share the wording and gives us a small testable surface for
 * "don't drop the device code".
 */
